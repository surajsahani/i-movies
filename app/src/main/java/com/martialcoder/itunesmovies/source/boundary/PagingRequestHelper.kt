...
import com.martialcoder.itunesmovies.source.boundary.PagingRequestHelper.Callback
 ...
 */
    ...
    private val mRequestQueues =
        arrayOf(RequestQueue(RequestType.INITIAL), RequestQueue(RequestType.BEFORE), RequestQueue(
            RequestType.AFTER
        ))
 ...
 */
typealias Request = ((Callback) -> Unit)